...
1. [ ] **Monitoring:**
    1. [ ] O: make new SRE 'admin' on [private monitoring infrastructure](https://dashboards.gitlab.net/) (Note: make sure Onboarder logs in first to ensure account creation)
